...
<body>
		...
		<div class="backgroundimg">
			<div class="box1">
				...
				<form name="login" action="" method="post">
					<div class="login">
						<input class="form-control" type="text" name="Company_id" placeholder="Company ID" required=" " style="font-family: Lucida Bright; font-size: 30px;">
						<br>
				...
				<p style="font-family: Lucida Bright;">
					<br><br>
					<a style="font-size: 20px; color: white; padding-left: 270px; text-decoration: none; " href="update_passwordc.php">Forgot Password?</a><br>
					<a  style="font-size: 25px; color: orange; padding-left: 230px;text-decoration: none; " href="company_registration.php">New Here? Sign-Up</a>	
				</p>
			</div>						
		</div>
		<?php
	...
	<?php
		...
		{
			$count = 0 ;
			$sql = "SELECT * FROM company WHERE c_id = '$_POST[Company_id]'&& PASSWORD = '$_POST[Password]' ";
