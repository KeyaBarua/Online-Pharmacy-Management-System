...
<body>
	...
	<h1 style="color: black; font-family: lucida Bright; text-align: center; padding-top: 20px;"><b>Patients</b></h1>
	

	<?php

		if(isset($_SESSION['login_user'])){
			$sql = "SELECT * FROM patient WHERE s_id='".$_COOKIE['PHPSESSID']."' ORDER BY Username ";
			$res=mysqli_query($link, $sql);
			if(mysqli_num_rows($res)==0){
				echo "<p style='color: red; font-size:30px; text-align: center; font-family: Lucida Bright; padding-top: 10px;'> <strong> <b>Sorry!!! No Patients Available! </b> </strong> </p>";
			}
				...
				while ($row=mysqli_fetch_assoc($res)) {
							...
							echo "<p style='padding-left: 15px;'>".$row['Username']."</p>"; 
							echo "</td>";
							echo "<td style='text-align:left; font-family: Lucida Bright; font-size: 18px; '>"; 
