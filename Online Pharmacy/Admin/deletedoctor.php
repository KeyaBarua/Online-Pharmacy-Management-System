...
<body>
	...
	<h1 style="color: black; font-family: lucida Bright; text-align: center; padding-top: 20px;"><b>Remove Doctors</b></h1>
	<form class="navbar-form" method="post" name="form1" style="text-align: center; padding-top: 18px; padding-right: 60px;">
		<input type="text" name="delete" class="form-control" placeholder="Enter Doctor ID" style="font-family: Lucida Bright; font-size: 18px; height: 40px; width: 350px;">
	...
	<?php
		...
		if(isset($_POST['submit'])){
			$sql = "DELETE FROM doctor WHERE s_id='".$_COOKIE['PHPSESSID']."' AND Doctor_id LIKE '%$_POST[delete]' ";
			$res=mysqli_query($link, $sql);
			echo "<h1 style='color:red; font-family:Lucida Bright;'>DOCTOR DELETED SUCCESSFULLY</h1> ";
		}
		mysqli_close($link);
		?>
	</section>
