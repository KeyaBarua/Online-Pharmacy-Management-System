...
<body>
	...
	<h1 style="color: black; font-family: lucida Bright; text-align: center; padding-top: 20px;"><b>PHARMACEUTICAL COMPANIES</b></h1>
	

	<?php

		if(isset($_SESSION['login_user'])){
			$sql = "SELECT * FROM company WHERE s_id='".$_COOKIE['PHPSESSID']."' ORDER BY c_id ";
			...
			if(mysqli_num_rows($res)==0){
				...
				while ($row=mysqli_fetch_assoc($res)) {
							...
							echo "</td>";
							echo "<td style='text-align:center; font-family: Lucida Bright; font-size: 18px; '>"; 
							echo "<p style='padding-left: 15px;'>".$row['website']."</p>"; 
							echo "</td>";
							echo "</tr>";
						}
						echo "</table>";		
