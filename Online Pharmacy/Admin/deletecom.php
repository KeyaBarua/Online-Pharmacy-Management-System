...
<body>
	...
	<h1 style="color: black; font-family: lucida Bright; text-align: center; padding-top: 20px;"><b>Remove Companies</b></h1>
	<form class="navbar-form" method="post" name="form1" style="text-align: center; padding-top: 18px; padding-right: 60px;">
		<input type="text" name="delete" class="form-control" placeholder="Enter Company Name" style="font-family: Lucida Bright; font-size: 18px; height: 40px; width: 350px;">
	...
	<?php
		...
		if(isset($_POST['submit'])){
			$sql = "DELETE FROM company WHERE s_id='".$_COOKIE['PHPSESSID']."' AND c_name LIKE '%$_POST[delete]' ";
			$res=mysqli_query($link, $sql);
			echo "<h1 style='color:red; font-family:Lucida Bright;'>COMPANY DELETED SUCCESSFULLY</h1> ";
		}
		mysqli_close($link);
		?>
	</section>
