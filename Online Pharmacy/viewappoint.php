...
<body>
	...
	<h1 style="color: black; font-family: lucida Bright; text-align: center; padding-top: 20px;"><b>APPOINTMENTS</b></h1>
	

	<?php

		if(isset($_SESSION['login_user'])){
			$sql = "SELECT * FROM appointment WHERE doc_id='$_SESSION[login_user]'  ";
			$res=mysqli_query($link, $sql);

			if(mysqli_num_rows($res)==0)
			{
				echo "<p style='color: red; font-size:40px; text-align: center; font-family: Lucida Bright; padding-top: 15px;'> <strong> <b>Sorry!!! No Recent Appointents! </b> </strong> </p>";
			}
				...
				echo "<th style='text-align:center;'>"; echo "Patient Name";  echo "</th>";
				echo "<th style='text-align:center;'>"; echo "Patient Email";  echo "</th>";
				echo "<th style='text-align:center;'>"; echo "Patient Phone no.";  echo "</th>";
				echo "</tr>";		
