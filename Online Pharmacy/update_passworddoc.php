...
<body>
	...
	<section>
		<div class="backgroundimg">
			<div class="box1">
				...
				<input style="height: 40px; font-family: Lucida Bright; font-size: 25px;" type="text" name="docid" class="form-control" placeholder="Doctor ID" required=""><br>
	...
	<?php
		...
		{
			$sql = "UPDATE doctor SET PASSWORD='$_POST[password]' WHERE Doctor_id = '$_POST[docid]'&& Email = '$_POST[email]' ";
