...
<body>
	...
	<section>
		...
		<div class="wrapper">
 			<?php
 			if(isset($_SESSION['login_user'])){
 				$sql="SELECT * FROM patient WHERE Username LIKE '%$_SESSION[login_user]%'  ";
				...
				<?php
					...
					echo "<tr>";
	 				echo "<td>";
	 					echo "<p style='color:black; padding-left: 15px;'>"."Patient Name"."</p>" ; echo "</td>";
	 				echo "</td>";
	 				echo "<td>";
	 					echo "<p style='color:black; padding-left: 15px;'>".$row['Full_name']."</p>" ; echo "</td>";
	 				echo "</td>";
	 				echo "</tr>";
	 				...
	 				echo "<tr>";
	 				echo "<td>";
	 					echo "<p style='color:black; padding-left: 15px;'>"."Patient UserName"."</p>" ; echo "</td>";
	 				echo "</td>";
	 				echo "<td>";
	 					echo "<p style='color:black; padding-left: 15px;'>".$row['Username']."</p>" ; echo "</td>";
	 				echo "</td>";
	 				echo "</tr>";
