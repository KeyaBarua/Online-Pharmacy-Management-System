...
<body>
	...
	<h1 style="color: black; font-family: lucida Bright; text-align: center; padding-top: 20px;"><b>ORDERS</b></h1>
	

	<?php

		if(isset($_SESSION['login_user'])){
			$sql = "SELECT cart.Med_id, order_details.user_id, order_details.user_name, order_details.user_email, order_details.user_contact, order_details.user_address FROM cart, order_details, medicine WHERE cart.Username=order_details.user_id AND cart.Med_id=medicine.medicine_id " ;
			$res=mysqli_query($link, $sql);
			$count=mysqli_num_rows($res);
			if($count==0){
				echo "<h1 style='text-align:center; color:red; font-family:Lucida Bright;'>"."NO PENDING ORDERS!!"."</h1>";
			}
			else{
			echo "<table class='table table-bordered table-hover'>";
						...
						echo "<th style='text-align:center;'>"; echo "User Email";  echo "</th>";
						echo "<th style='text-align:center;'>"; echo "User Contact";  echo "</th>";
						echo "<th style='text-align:center;'>"; echo "User Address";  echo "</th>";
						echo "</tr>";
						...
						echo "<a href='med_details.php'><p style='padding-left: 15px;'>".$row['user_id']."</a></p>"; 
						echo "</td>";
						echo "<td style='text-align:left; font-family: Lucida Bright; font-size: 18px; '>"; 
						echo "<p style='padding-left: 15px;'>".$row['user_name']."</p>"; 
						echo "</td>";
						echo "<td style='text-align:center; font-family: Lucida Bright; font-size: 18px; '>"; 
						echo $row['user_email']; 
						echo "</td>";
